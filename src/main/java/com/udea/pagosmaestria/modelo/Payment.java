 ...
 */
package com.udea.pagosmaestria.modelo;
...
public class Payment implements Serializable {
    ...
    public Payment(Integer id, double amount, long card, Date date, int cvvno) {
        this.id = id;
        this.amount = amount;
        this.card = card;
        this.date = date;
    ...
    public String toString() {
        return "com.udea.pagosmaestria.modelo.Payment[ id=" + id + " ]";
    }
